...
namespace MJ_13.Controllers
{
    public class PredicadorController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Nombre,Telefono,Email,TipoID")] Predicadores predicadores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nombre,Telefono,Email,TipoID")] Predicadores predicadores)
        {
            if (ModelState.IsValid)
            {
